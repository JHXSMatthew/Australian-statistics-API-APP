    ...
    <div class="row">
        ...
        <div class="col-sm-8 blog-main">
            ...
            <div class="blog-post">
                ...
                <p>API link <a href="http://45.76.114.158/api">http://45.76.114.158/api </a>
                    You may try it with an
                    <a href='http://45.76.114.158/api?StatisticsArea=Retail&State=NSW&Category=ClothingFootwareAndPersonalAccessory,DepartmentStores&startDate=2013-01-01&&endDate=2014-01-01'/>
                    example usage</a>
                </p>
                <p>The Australian statistics APi we developed currently works without exceptions handling and log file
                    generation. So when you give some parameters it does not understand, it won't return you a
                    JSON. </p>
                <p> The parameters you may use can be found in the <a
                        href="https://webcms3.cse.unsw.edu.au/static/uploads/course/SENG3011/17s1/12e2001fa2ebeef1e92aee56fe253667785387e9407869670379c05fe0f78718/AustralianStatisticsAPI_V1_3.pdf"/>
                    specification </a> provided by SENG3011. We will build a API documentation in a few days from 23rd
                    March.</p>
