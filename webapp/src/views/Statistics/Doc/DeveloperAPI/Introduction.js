    ...
    return (
      <div className="animated fadeIn">
        <div className="row">
          ...
          <div className="col-2" style={{backgroundColor: 'black', color:'white'}}>
            <div style={{position: 'fixed'}}>
            <Link to="introduction" spy={true} smooth={true} offset={50} duration={500} >Introduction</Link> <br/>
            <Link to="parameterConstraints" spy={true} smooth={true} offset={50} duration={500} >Parameter Constraints</Link> <br/>
            <Link to="retail" spy={true} smooth={true} offset={50} duration={500} >Retail</Link> <br/>
            <Link to="merchandiseExports" spy={true} smooth={true} offset={50} duration={500} >Merchandise Exports</Link> <br/>
            </div>
          </div>
